...
def cli():
    ...
    parser.add_argument("-d", "--dir", type=str, default="",
                        help="the directory used for data")
    parser.add_argument("-rd", "--res_dir", type=str, default="results_snellius/case_14",
                        help="", )
    ...
    parser.add_argument('-s', '--sample',
                        help="sample action instead of always take mean / argmax",
                        action='store_true')
...
if __name__ == '__main__':
    ...
    for agent_dir in all_agents:
        ...
        stats, scores, steps = trainer.my_evaluate(test_chronics, MAX_FFW[args.case], agent_dir,
                                                   args.sample)  # mode, plot_topo=True)
